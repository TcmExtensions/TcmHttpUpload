...
namespace TcmHttpUpload.Logging
{
	/// <summary>
	...
	///      - Error
	///     --&gt;
	///         &lt;source name="TcmHttpUpload" switchValue="Verbose"&gt;
	///             &lt;listeners&gt;
	///              &lt;remove name="Default" /&gt;
	///                 &lt;add name="FileLogListener" type="TcmHttpUpload.Logging.RolloverTraceListener, TcmHttpUpload" initializeData="c:\data\logs\httpupload.log" /&gt;
	///             &lt;/listeners&gt;
	///         &lt;/source&gt;
	///     &lt;/sources&gt;
	...
	public sealed class Logger
	{
		...
		private static TraceSource Source
		{
			...
			{
				if (mSource == null)
					mSource = new TraceSource("TcmHttpUpload");
